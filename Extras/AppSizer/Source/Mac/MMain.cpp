 ...
 *
 *		$Log: MMain.cpp,v $
 *		Revision 1.5  2001/05/06 10:34:27  jesjones
 *		Nuked the call to SetSleepTime and the MPreferences.
 *		
 *		Revision 1.4  2001/04/13 07:50:50  jesjones
 *		Ported to CarbonLib 1.3b2
 *		
 *		Revision 1.3  2001/02/08 07:10:09  jesjones
 *		War on implementation inheritance fixups.
 *		
 *		Revision 1.2  2001/01/01 03:49:31  jesjones
 *		Fixed the class registeration.
 *		
 *		Revision 1.1.1.1  2000/12/27 03:12:47  jesjones
 *		First Imported.
 *		
...
{	
	try {							
		...
		IDropAppPtr drop(L"Application");
			...
			filter->AddType(XFileType(L"Map File", L"xMAP"));
